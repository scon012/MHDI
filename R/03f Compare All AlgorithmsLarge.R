...
library(methods)
library(imputeTS)
library(hydroGOF) # For NRMSE routine
...
resultsFile = "c:\\temp\\results.small.csv"
variancesFile = "c:\\temp\\results.variances.small.csv"
...
#datasets = c("df100p10s","df100p20s","df100p30s","df100p40s","df100p50s","df100p60s","df100p70s","df100p80s","df100p90s","df1kp10s","df1kp20s","df1kp30s","df1kp40s","df1kp50s","df1kp60s","df1kp70s","df1kp80s","df1kp90s","df10kp10s","df10kp20s","df10kp30s","df10kp40s","df10kp50s","df10kp60s","df10kp70s","df10kp80s","df10kp90s","df10kp10s","df10kp20s","df10kp30s","df10kp40s","df10kp50s","df10kp60s","df10kp70s","df10kp80s","df10kp90s")
datasets = c("df10kp60s","df10kp70s","df10kp80s","df10kp90s","df10kp60s","df10kp70s","df10kp80s","df10kp90s","df10kp60s","df10kp70s","df10kp80s","df10kp90s")
#true.datasets = c("df100p0s","df100p0s","df100p0s","df100p0s","df100p0s","df100p0s","df100p0s","df100p0s","df100p0s","df1kp0s","df1kp0s","df1kp0s","df1kp0s","df1kp0s","df1kp0s","df1kp0s","df1kp0s","df1kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s")
true.datasets = c("df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s","df10kp0s")
#missingnesses = c(10,20,30,40,50,60,70,80,90,10,20,30,40,50,60,70,80,90,10,20,30,40,50,60,70,80,90,10,20,30,40,50,60,70,80,90)
missingnesses = c(60,70,80,90,60,70,80,90,60,70,80,90)
#algorithms = c("MeanMode", "MissForest", "Mice", "MissRanger")
algorithms = c("MeanMode", "MissForest", "MissRanger")
#algorithms = c("MeanMode", "MissForest", "MissRanger","Mice")
size = "s"
...
##############################################################
# Variances file write commented out
##############################################################
print('Variances file write commented out')
  ...
  for (params in 1:length(datasets)) {
    ...
    for (method in algorithms) {
      ...
      if (method == "MissForest") {
        ...
        start = Sys.time()
        imputed = missRanger(missing.df, maxiter = 100, verbose = 1, num.trees = 1000)
      ...
      # This function is provided by MissForest and is called if an "xtrue" parameter is used. We use it separately because we want to use the same function for all the algorithms.
  
      mydiff = mixError(imputed, missing.df, p0.df)
      # Run the NRMSE routine from hydroGOF because it works on larger datasets.
      mydiff["NRMSE"] = myNRMSE(imputed, missing.df, p0.df)
      # if (is.na(mydiff["NRMSE"])) {
      #   # Calculate the NRMSE differently
      #   mydiff["NRMSE"] = myNRMSE(imputed, missing.df, p0.df)
      # }
